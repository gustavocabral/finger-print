...
public abstract class DrEditServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		credentialManager = new CredentialManager(getClientSecrets(), TRANSPORT, JSON_FACTORY);
	}

	/**
	 * Static instance of Gson
	 */
	 ...
	 * @throws IOException 
	 */
	protected void loginIfRequired(HttpServletRequest req, HttpServletResponse resp) throws IOException {
	...
	/**
	 * Static instance of google client secretes
	 */
	...
	private GoogleClientSecrets getClientSecrets() {
		if (googleClientSecrets == null) {
			...
			try {
				googleClientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(stream));
			} catch (IOException e) {
